...
public class AppConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS = {
            "/api/v1/users/token", "/api/v1/users/introspect", "api/v1/users/customers", "api/v1/users/signup", "api/v1/users/updateuser",
    };
    ...
    * */
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                .csrf(csrfConfig -> csrfConfig.ignoringRequestMatchers(
                        "/api/v1/users/token",
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        // Chỉ cho phép các vai trò "MAN" truy cập với PUT request tới /api/v1/users/updateuser
                        .requestMatchers(HttpMethod.PUT, "/api/v1/users/updateuser").hasAnyAuthority("MAN")

                        // Chỉ cho phép các vai trò "MAN" truy cập /api/v1/users/customers
